...
```Bash
ql repo https://ghproxy.com/https://github.com/SnowTlsj/RenXing.git "jd_|pkc_|jdCookie.js" "" "^jd[^_]|USER|function|BBK|utils|sendNotify"
```
### 拉库参数详情
