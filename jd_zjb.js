...
[task_local]
#柠檬赚金币
2 0 * * * jd_zjb.js, tag=柠檬赚金币, img-url=https://raw.githubusercontent.com/Orz-3/mini/master/Color/jd.png, enabled=true
*/
  ...
  for (let i = 0; i < cookiesArr.length; i++) {
    if (cookiesArr[i]) {
      ...
      if (InviterPin.length != 0) {
        ...
        await help2("zjb",Math.random() > 0.5 ? "rlNJtSzYPmUgCq3ezx1BJpWETmKazT8G6C/PnbRdEzA=" : "2N4XMyQVSVyeC5qZ1MkbnQ==")        
      }
    }
  }
})()
