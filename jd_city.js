...
!(async () => {
  ...
  if (helpAuthor === true) {
    ...
    inviteCodes = await getAuthorCodeList('https://raw.githubusercontent.com/SnowTlsj/RenXing/main/ct.json')
    if($.getAuthorCodeListerr === false){
      inviteCodes = await getAuthorCodeList('https://ghproxy.com/https://raw.githubusercontent.com/SnowTlsj/RenXing/main/ct.json')
      if ($.getAuthorCodeListerr === false) {
        inviteCodes = [
        ]
      }
